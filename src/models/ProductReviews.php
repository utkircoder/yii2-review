...
class ProductReviews extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['review_id', 'product_id'], 'required'],
            [['review_id', 'product_id', 'sort', 'created_at', 'updated_at'], 'integer'],
    ...
    /**
     * {@inheritdoc}
     * @return \common\modules\review\queries\ProductReviewsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\modules\review\queries\ProductReviewsQuery(get_called_class());
    }
}
